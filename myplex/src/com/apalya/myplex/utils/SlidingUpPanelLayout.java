...
// com.apalya.myplex.utils.SlidingUpPanelLayout
...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final int DEFAULT_MIN_FLING_VELOCITY = 16000; // dips per second
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mFirstLayout) {
            switch (mSlideState) {
            case EXPANDED:
                mSlideOffset = mCanSlide ? mAnchorPoint : 1.f;  //  mSlideOffset = mCanSlide ? 0.f : 1.f;
                break;
            case ANCHORED:
    ...
    public boolean expandPane() {
        return expandPane(mAnchorPoint);  // return expandPane(0);
    }
