 ...
 */
package com.apalya.myplex.listboxanimation;
...
public abstract class AnimationAdapter extends BaseAdapterDecorator {
	...
	private boolean movingTowardsUp = true; 
	private int mLastPosition = 0;
	private void animateViewIfNecessary(int position, View view, ViewGroup parent) {
		movingTowardsUp =(mLastPosition > position)?false:true; 
		mLastPosition = position;
		if (/*position > mLastAnimatedPosition*/movingTowardsUp && !mHasParentAnimationAdapter && mShouldAnimate) {
